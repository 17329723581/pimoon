...
module.exports = function (source) {
  ...
  global.__DEBUG__ = process.env.DEBUG === 'stylus-resources-loader' || process.env.DEBUG === '*';
  ...
  var isWebpack2 = webpack.version === 2;
  var resourcesFromConfig = isWebpack2 ? (_loaderUtils2.default.getOptions(this) || {}).resources : webpack.options.stylusResources;

  if (!resourcesFromConfig) {
    var error = new Error('\n      Can\'t find stylus resources in your config.\n      Make sure ' + (isWebpack2 ? 'loader.options.resources' : 'webpackConfig.stylusResources') + ' exists.\n    ');
